/**
 * Copyright (c) 2010 北京数字政通科技股份有限公司 版权所有
 * 
 * 修改标识：赵冲20110506 修改描述：创建
 */
...
public class RegularExpression {
    ...
    public static boolean isWorkPhone(String toCheckStr) {
        String patternStr =
                "(^[0-9]{3,4}-[0-9]{7,8}-[0-9]{3,4}$)|(^[0-9]{3,4}-[0-9]{7,8}$)|(^[0-9]{7,8}-[0-9]{3,4}$)|(^[0-9]{7,8}$)";
        return canMatch(toCheckStr, patternStr);
    }
     ...
     */
    public static boolean isContainSpecialCharacter(String toCheckStr){
        String patternStr = "[ _`~!@#$%^&*()+=|{}':;',\\[\\].<>/?~！@#￥%……&*（）——+|{}【】‘；：”“’。，、？]|\n|\r|\t";
        return canMatch(toCheckStr, patternStr);
    }
     ...
     * @return:
     * @auther: libangzheng
     * @date: 2018/11/13 21:02
     */
    public static boolean isContainDigit(String toCheckStr) {
        String patternStr = ".*\\d+.*";
        return canMatch(toCheckStr, patternStr);
    }

    /**
     * @description: 判断是否包含小写字母
     * @param:
     * @return:
     * @auther: libangzheng
     * @date: 2018/11/13 21:03
     */
    public static boolean isContainLowerCharacter(String toCheckStr){
    ...
    /**
     * @description: 判断是否包含大写字母
     * @param:
     * @return:
     * @auther: libangzheng
     * @date: 2018/11/13 21:03
     */
    public static boolean isContainUpperCharacter(String toCheckStr){
        String patternStr = ".*[A-Z]+.*";
        return canMatch(toCheckStr, patternStr);
    }

    /**
     * @description: 判断一个字符串中是否既包含数字,小写字母,大写字母,特殊字符中的任意三种
     * @param:
     * @return:
     * @auther: libangzheng
     * @date: 2018/11/13 21:05
     */
    public static boolean isContainsSpecialCharacterAndNumberAndCharacter(String toCheckStr){
//        String patternStr = "^(?![a-zA-Z]+$)(?![A-Z0-9]+$)(?![A-Z\\W_!@#$%^&*`~()-+=]+$)(?![a-z0-9]+$)(?![a-z\\W_!@#$%^&*`~()-+=]+$)(?![0-9\\W_!@#$%^&*`~()-+=]+$)[a-zA-Z0-9\\W_!@#$%^&*`~()-+=]{8,}$";
//        String patternStr = "^(?=.*?[a-z])(?=.*?[A-Z])(?=.*?\\d)(?=.*?[!@#?$%^&*`~()<>|\\-+=.:{};\\/\\[\\]])[a-zA-Z\\d!@?#$%^&*`~\\()<>|\\-+=.:{};\\/\\[\\]]{8,}$";
        String patternStr = "^(?=.*[a-zA-Z])(?=.*[1-9])(?=.*[\\W]).{8,}$";
        return canMatch(toCheckStr,patternStr);
    }
