...
public class CommonsUtils {
  ...
  public static void createDirs(String dirPath) {
    Assert.isNotEmpty(dirPath, ErrorCodeEnum.ILLEGAL_PARAMETER);
  ...
  public static String getPrintSize(String size) {
    Assert.isNumeric(size, ErrorCodeEnum.ILLEGAL_PARAMETER);
  ...
  public static boolean isMobileExact(CharSequence input) {
    return isMatch(AucConst.REGEX_MOBILE_EXACT, input);
  }
